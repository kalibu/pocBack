package com.kalibu.pocBack.filter;
...
import com.kalibu.pocBack.service.JwtTokenService;
...
public class UserAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        //verify if it is a private request
        if (checkIfEndpointIsNotPublic(request)) {
            ...
            if (token != null) {
                ...
                throw new RuntimeException("Without Token");
            }
        }
    ...
    private boolean checkIfEndpointIsNotPublic(HttpServletRequest request) {
        ...
        final List<String> urls = Arrays.stream(
                        SecurityConfiguration.ENDPOINTS_WITH_AUTHENTICATION_NOT_REQUIRED)
